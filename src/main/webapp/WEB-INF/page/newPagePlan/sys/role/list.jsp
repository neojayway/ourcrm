...
<script language="javascript">
	function setPopedom(id) {
		OpenWin(
			'${pageContext.request.contextPath}/sysPopedomAction.do?method=view&roleId='
				+ id, '', 800, 600);
	}
	function setMenu(id) {
		OpenWin(
			'${pageContext.request.contextPath}/sysMenuAction.do?method=view&roleId='
				+ id, '', 800, 600);
	}
</script>
</head>
...
<body>
		...
		<tr>
			<td colspan="2">
				<form name="searchForm" method="post"
					action="${pageContext.request.contextPath}/sys/sysRoleAction_list.do">
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						name="base" id="base">
						<tr>
							<td width="38%" nowrap>名称： 
								<input name="name" type="text"
									id="name" value="" style="width: 140px">
							</td>
							...
							<td width="23%" align="center">
								<div class="control">
									...
									<button type='button' class='button'
										onMouseOver="this.className='button_over';"
										onMouseOut="this.className='button';"
										onClick="forward('role.do?method=search')">
	...
	<div class="border">
		<form name="ActionForm" method="post"
			action="${pageContext.request.contextPath}/sys/sysRoleAction_delete.do">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td>
						<a href="${pageContext.request.contextPath}/sys/sysRoleAction_edit.do">
							销售部操作权限
						</a>
					</td>
					<td>
						<a href="#" onClick="setMenu('aaaaaa')">设置</a>
					</td>
					<td>
						<a href="#" onClick="setPopedom('aaaaaa')">设置</a>
					</td>
				</tr>
			</table>
		</form>
