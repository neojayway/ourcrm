					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<input name="module" type="text" class="disabled"
										id="module" style="width: 90%" value="商品类别" readonly>
								</td>
								<td class="red">数据库表名：</td>
								<td>
									<input name="tab_name" type="text" class="disabled"
										id="tab_name" style="width: 90%" value="b_product_type" readonly>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="area_prefix" type="text" class="input"
										id="area_prefix" style="width: 90%" value="PTYPE">
								</td>
								<td class="red">流水位：</td>
								<td>
							...
							<tr>
								<td class="red">日期位：</td>
								<td colspan="3">
									<input type='radio' name='area_time' id='area_time' value='yyyyMMdd' class='radio' checked>
									yyyyMMdd
									<input type='radio' name='area_time' id='area_time' value='yyyy-MM-dd' class='radio'>
									yyyy-MM-dd
									<input type='radio' name='area_time' id='area_time' value='yyyyMM' class='radio'>
									yyyyMM
									<input type='radio' name='area_time' id='area_time' value='yyyy-MM' class='radio'>
									yyyy-MM
									<input type='radio' name='area_time' id='area_time' value='yyyy' class='radio'>
									yyyy
									<input type='radio' name='area_time' id='area_time' value='NULL' class='radio'>
									无
								</td>
							</tr>
						</table>
