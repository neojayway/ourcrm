...
<body>
	<form name="ActionForm" method="post" action="city.do"
							...
							<tr>
								...
								<td>
									<input name="name" type="text" class="input" id="name"
										style="width: 90%" value="北京">
								</td>
								<td class="red">拼音码：</td>
								<td>
									<input name="pycode" type="text" class="input"
										id="pycode" style="width: 90%" value="bj">
								</td>
							</tr>
							<tr>
								<td>邮政编码：</td>
								<td>
									<input name="postcode" type="text" class="input"
										id="postcode" style="width: 90%" value="100000">
								</td>
								<td>区号：</td>
								<td>
									<input name="areacode" type="text" class="input"
										id="areacode" style="width: 90%" value="010">
								</td>
							</tr>
							<tr>
