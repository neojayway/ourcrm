...
<body>
	<form name="form1" method="post" action="sysUserAction_update.do" namespace="/sys">
		...
		<div class="control">
			...
			<button type='button' class='button'
				...
				<img src="${pageContext.request.contextPath}/ui/images/button/xgmm.png"
					border='0' align='absmiddle'>
				&nbsp;修改密码
			</button>
			<button type='button' class='button'
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td class="red">用户名：</td>
								<td>
									<input type="text" name="name" id="name" cssClass="disabled"
										cssStyle="width:90%" readonly="true" />
								</td>
								<td class="red">中文名：</td>
								<td>
									<input type="text" name="cnname" id="cnname" cssClass="input"
										cssStyle="width:90%" />
								</td>
							</tr>
							<tr>
								<td class="red">密码：</td>
								<td>
									<input type="password" name="password" showPassword="true"
										id="password" cssClass="disabled" cssStyle="width:90%"
										readonly="true" />
								</td>
								<td>推荐人：</td>
								<td>
					...
					<div id="menu2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>职员类别：</td>
								<td>
									<input type="radio" list="{'全职','兼职'}" name="personnelType"
							...
							<tr>
								...
								<td>毕业时间：</td>
								<td>
									<input type="text" name="finishSchoolDate"
					...
					<div id="menu3">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>信息沟通：</td>
								<td>
									<textarea name="commUniCate" id="commUniCate"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									...
									<input type="text" name="updater" cssClass="disabled" id="updater"
										readonly="true" />
								</td>
								<td>修改时间：</td>
								<td>
									<input type="hidden" name="updateTimeStr" /> 
									<input type="text" name="updateTime" cssClass="disabled" id="updateTime"
										readonly="true" />
								</td>
							</tr>
						</table>
	...
	<div id="popshow" style='border: 1px solid #6A82A8; width =650px; 
				...
				<td align='right' onselectstart="return false">
					<a href='#' onClick="close_window();"> 
						<img src="${pageContext.request.contextPath}/ui/images/xpclose.jpg"
							width="20" height="20" border="0" onClick="" 
							align="absmiddle">
					</a>
				</td>
			</tr>
