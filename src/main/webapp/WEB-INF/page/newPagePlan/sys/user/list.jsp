...
<body>
						...
						<tr>
							...
							<td width="12%" nowrap="nowrap">
								<input type="text" name="name"
									id="name" cssStyle="width:100px" value="" />
							</td>
							<td width="13%" nowrap="nowrap">中文名：</td>
							<td width="12%" nowrap="nowrap">
								<input type="text" name="cnname"
									id="cnname" cssStyle="width:100px" value="" />
							</td>
							...
							<td width="25%" align="center">
								<div class="control">
									<button type='button' class='button'
										...
										onClick="toSearch(1,${pageBean.maxSize})">
						...
						<tr>
							...
							<td>
								<input type="radio" list="#{'Y':'启用','N':'停用'}" name="status"
									id="status" listKey="key" listValue="value" />
							</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
							<td>&nbsp;</td>
	...
	<div class="control">
		...
		<button type='button' class='button'
			...
			<img src="${pageContext.request.contextPath}/ui/images/button/qiyong.png"
				border='0' align='absmiddle'>
			&nbsp;启用
		</button>
		<button type='button' class='button'
			...
			<img src="${pageContext.request.contextPath}/ui/images/button/tingyong.png"
				border='0' align='absmiddle'>
			&nbsp;停用
		</button>
		<button type='button' class='button'
	...
	<!-- list -->
	<div class="border">
		<form name="form2" method="post" action="sysUserAction_delete.do"
			namespace="/sys">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<c:if test="#request.sysUserList!=null">
					<c:forEach value="#request.sysUserList" var="sysUser">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/sys/sysUserAction_edit.do?id=<s:property value="#sysUser.id"/>"><s:property
										value="#sysUser.name" />
								</a>
							</td>
