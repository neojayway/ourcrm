...
<script src="${pageContext.request.contextPath}/ui/js/jquery-1.3.1.js"
...
<body>
			...
			<th class="th_head">
				<div align="right" name="base1" id="base1">
					<a class="tabFormAdvLink" href="javascript:showadv(0);"> 
						<img alt=""
							src="${pageContext.request.contextPath}/ui/images/advanced_search.gif"
							border="0" />
						&nbsp;高级查询
					</a>
				</div>
				<div style="display: none" align="right" name="adv1" id="adv1">
					<a class="tabFormAdvLink" href="javascript:showadv(1);"> 
						<img alt=""
							src="${pageContext.request.contextPath}/ui/images/basic_search.gif"
							border="0" />
						&nbsp;基本查询
					</a>
				</div>
			...
			<td colspan="2">
				<form name="form1" method="post" action="customer.do">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td width="12%" nowrap>
								<input name="name" type="text"
									id="name" value="" style="width: 100px">
							</td>
							<td width="13%" nowrap>所属人：</td>
							<td width="12%" nowrap>
								<select id='owner_usr'
									name='owner_usr' style='width: 100px'>
									<option value='' selected>------</option>
							...
							<td width="25%" align="center">
								<div class="control">
									...
									<button type='button' class='button'
										onMouseOver="this.className='button_over';"
										onMouseOut="this.className='button';"
										onClick="forward('customer.do?method=select&columns=name&m=doCustomer2')">
						...
						<tr>
							<td>拼音码：</td>
							<td>
								<input name="pycode" type="text" id="pycode" value=""
									style="width: 100px">
							</td>
							<td>电话一：</td>
							<td>
				...
				<form name="form2" method="post" action="customer.do">
					...
					<table width="100%" style="display: none" border="0"
						cellspacing="0" cellpadding="0" name="adv" id="adv">
						<tr>
							<td width="13%" nowrap>客户性质：</td>
							<td width="12%" nowrap>
								<select id='quality' name='quality'
	...
	<div class="control">
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';" onClick="window.close();">
	...
	<div class="border">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td width="71%" align="right">
					共8条&nbsp;&nbsp;首页&nbsp; 上一页&nbsp;
					1/1&nbsp; 下一页&nbsp; 末页&nbsp; 
					<select id='_pj_pages1'
						name='_pj_pages1' onChange='toPage1()' style=''>
						<option
							value='1' selected>第1页
						</option>
					</select>
				<script>
					function toPage1() {
						var _pj_pages = document.getElementById('_pj_pages1').value;
						var _pj_pageFlag = 'pages';
						var _pj_url = '/crm/customer/customer.do?m=doCustomer2&columns=name&method=select&pages=1&pageSize=10';
						var _pj_p_re = new RegExp(_pj_pageFlag + '=\\d+', 'g');
						_pj_url = _pj_url.replace(_pj_p_re, _pj_pageFlag + '='
								+ _pj_pages);
						window.location = _pj_url;
					}
				</script>
				
				<select id='_pj_pagesize1' name='_pj_pagesize1' 
					onChange='changeSize1()' style=''>
				...
				<script>
					function changeSize1() {
						var _pj_pagesize = document
								.getElementById('_pj_pagesize1').value;
						var _pj_pagesizeFlag = 'pageSize';
						var _pj_url = '/crm/customer/customer.do?m=doCustomer2&columns=name&method=select&pages=1&pageSize=10';
						var _pj_p_re = new RegExp(_pj_pagesizeFlag + '=\\d+',
								'g');
						_pj_url = _pj_url.replace(_pj_p_re, _pj_pagesizeFlag
								+ '=' + _pj_pagesize);
						window.location = _pj_url;
					}
				</script>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('eeeee')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
					</td>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('北京软通动力软件技术有限公司')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('ttttttt')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('iiiii')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('dfdfgfdgd')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('zxvcdzxvdcv')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
				...
				<tr>
					<td>
						<button type='button' class='button'
							onMouseOver="this.className='button_over';"
							onMouseOut="this.className='button';"
							onClick="javascript:parent('dddd')">
							<img src="${pageContext.request.contextPath}/ui/images/button/xuanze.png"
								border='0' align='absmiddle'>
							&nbsp;选择
						</button>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<script>
					function toPage2() {
						var _pj_pages = document.getElementById('_pj_pages2').value;
						var _pj_pageFlag = 'pages';
						var _pj_url = '/crm/customer/customer.do?m=doCustomer2&columns=name&method=select&pages=1&pageSize=10';
						var _pj_p_re = new RegExp(_pj_pageFlag+'=\\d+','g');
						_pj_url = _pj_url.replace(_pj_p_re,_pj_pageFlag+'='+_pj_pages);
						window.location = _pj_url;}
				</script>
				
				<select id='_pj_pagesize2' name='_pj_pagesize2' 
					onChange='changeSize2()' style=''>
					<option value='10' selected>10条</option>
					<option value='15'>15条</option>
					<option value='20'>20条</option>
					<option value='30'>30条</option>
				...
				<script>
					function changeSize2() {
						var _pj_pagesize = document.getElementById('_pj_pagesize2').value;
						var _pj_pagesizeFlag = 'pageSize';
						var _pj_url = '/crm/customer/customer.do?m=doCustomer2&columns=name&method=select&pages=1&pageSize=10';
						var _pj_p_re = new RegExp(_pj_pagesizeFlag+'=\\d+','g');
						_pj_url = _pj_url.replace(_pj_p_re,_pj_pagesizeFlag+'='+_pj_pagesize);
						window.location = _pj_url;}
				</script>
