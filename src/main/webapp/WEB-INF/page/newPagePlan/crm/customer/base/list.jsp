...
<body>
	...
	<div class="link_title">
		<br>&nbsp;&nbsp; <a
			href="${pageContext.request.contextPath}/newPagePlan/crm/customer/base/list.jsp">今天需要联系的客户</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a
			href="${pageContext.request.contextPath}/newPagePlan/crm/customer/base/list.jsp">已过期未联系的客户</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a
			href="${pageContext.request.contextPath}/newPagePlan/crm/customer/base/list.jsp">全部</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<td colspan="2">
				<!-- 基本查询的表单--> <s:form name="form1" method="post"
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td>电话一：</td>
							<td><input name="tel1" type="text" id="tel1" value=""
								style="width: 110px"></td>
							<td>客户等级：</td>
							<td><s:if test="%{#request.gradesSelect!=null}">
									<s:select list="%{#request.gradesSelect}" id='grade'
							...
							<td>客户来源：</td>
							<td><s:if test="%{#request.sourcesSelect!=null}">
									<s:select list="%{#request.sourcesSelect}" id='source'
						...
						<tr>
							<td>客户性质：</td>
							<td><s:if test="%{#request.qualitySelect!=null}">
									<s:select list="%{#request.qualitySelect}" id='quality'
	...
	<div class="control">
		...
		<button type='button' class='button'
			...
			<img
				src="${pageContext.request.contextPath}/ui/images/button/xiacilxsj.png"
				border='0' align='absmiddle'>&nbsp;下次联系时间
		</button>
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';" onClick="do_share()">
			<img
				src="${pageContext.request.contextPath}/ui/images/button/gongxiang.png"
				border='0' align='absmiddle'>&nbsp;共享
		</button>
		...
		<button type='button' class='button'
			...
			<img
				src="${pageContext.request.contextPath}/ui/images/button/jinshourbg.png"
				border='0' align='absmiddle'>&nbsp;经手人变更
		</button>
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';"
	...
	<div class="border">
		<s:form method="post" action="companyAction_delete.do"
			namespace="/sys">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<s:if test="#request.companyList!=null">
					<s:iterator value="#request.companyList" var="company">
						<tr>
							<td><s:checkbox name="ids" fieldValue="%{#company.id}"
									cssClass="checkbox" onclick="changeCheckCount();" /></td>
							<td><a
								href="${pageContext.request.contextPath}/crm/companyAction_edit.do?id=<s:property value="#company.id"/>"><s:property
										value="#company.name" /></a></td>
