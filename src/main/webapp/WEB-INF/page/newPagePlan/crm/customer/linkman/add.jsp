					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<input name="name" type="text" id="name"
										style="width: 90%" onChange="getPycode(this.value);">
								</td>
								<td>性别：</td>
								<td>
							...
							<tr>
								...
								<td>
									<input name="pycode" type="text" id="pycode"
										style="width: 90%" readonly class="disabled">
								</td>
							</tr>
							<tr>
								<td>出生日期：</td>
							...
							<tr>
								<td>办公电话：</td>
								<td>
									<input name="officeTel" type="text" id="office_tel"
										style="width: 90%">
								</td>
								<td>家庭电话：</td>
								<td>
									<input name="homeTel" type="text" id="home_tel"
										style="width: 90%">
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>QQ号：</td>
								<td>
									<input name="imNum" type="text" id="im_num"
										style="width: 90%">
								</td>
								<td>QQ昵称：</td>
								<td>
									<input name="imName" type="text" id="im_name"
										style="width: 90%">
								</td>
							</tr>
							<tr>
					...
					<div id="menu2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="16%">创建人：</td>
								<td width="34%">
									<input name="creater" class="disabled" type="text" 
										id="creater" style="width: 90%" readonly
										value="系统管理员">
								</td>
								<td width="16%">创建日期：</td>
								<td width="34%">
									<input name="create_time" class="disabled"
										value="2010-03-29 17:13:08" type="text" id="create_time"
							...
							<tr>
								...
								<td>
									...
									value="2010-03-29 17:13:08" type="text" id="update_time"
									style="width: 90%" readonly>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input name="ownerName" type="text" id="owner_name"
										class="disabled" style="width: 90%" readonly value="系统管理员">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
