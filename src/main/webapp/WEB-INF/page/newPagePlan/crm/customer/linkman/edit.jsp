...
<body>
	...
	<form name="ActionForm" method="post"
		action="${pageContext.request.contextPath}/crm/customer/linkman/edit.jsp"
		...
		<div class="control">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linkman.do?method=list')">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linkman.do?method=load&id=0')" disabled>
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linkman.do?method=load&id=2')">
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<input name="name" type="text" id="name"
										style="width: 90%" value="张国立"
										onChange="getPycode(this.value);">
								</td>
								<td>性别：</td>
								<td>
							...
							<tr>
								...
								<td>
									<input name="code" type="text" id="code"
										style="width: 90%" value="MAN-20100329-003">
								</td>
								<td>拼音码：</td>
								<td>
									<input name="pycode" type="text" id="pycode"
										style="width: 90%" value="zgl" readonly class="disabled">
								</td>
							</tr>
							<tr>
								<td>出生日期：</td>
							...
							<tr>
								...
								<td>职务：</td>
								<td>
									<input name="duty" type="text" id="duty"
										style="width: 90%" value="">
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>是否主联系人：</td>
								<td>
									<input type='radio' name='mainFlag' id='mainFlag'
										value='Y' class='radio'>
										是
									<input type='radio' name='main_flag' id='main_flag' 
							...
							<tr>
								<td>QQ号：</td>
								<td>
									<input name="imNum" type="text" id="imNum"
										style="width: 90%" value="">
								</td>
								<td>QQ昵称：</td>
								<td>
									<input name="imName" type="text" id="imName"
										style="width: 90%" value="">
								</td>
							</tr>
							<tr>
								...
								<td colspan="3">
									<input name="address" type="text"
										id="address" style="width: 96%" value="">
								</td>
							</tr>
							<tr>
								<td valign="top">其他联系：</td>
								<td colspan="3">
									<input name="otherLink" type="text"
										id="otherLink" style="width: 96%" value="">
								</td>
							</tr>
							<tr>
								<td valign="top">爱好：</td>
					...
					<div id="menu2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="16%">创建人：</td>
								<td width="34%">
									<input name="creater" type="text" class="disabled" 
										id="creater" value="系统管理员" style="width: 90%"
										readonly>
								</td>
								<td width="16%">创建日期：</td>
								<td width="34%">
									<input name="createTime" class="disabled"
										readonly value="2010-03-29 17:34:29" type="text"
										id="create_time" style="width: 90%">
								</td>
							</tr>
							<tr>
								<td>修改人：</td>
								...
								<td>
									<input type="hidden" name="updateTime"
										value="2010-03-29 17:34:46"> 
									<input name="updateTimeStr2" class="disabled" 
										readonly value="2010-03-29 17:34:29" 
										type="text" id="updateTimeStr2" 
										style="width: 90%">
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input name="ownerName" type="text" 
										id="ownerName" class="disabled" 
										style="width: 90%" readonly value="系统管理员">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
