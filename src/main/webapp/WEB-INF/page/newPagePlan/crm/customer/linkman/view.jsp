				...
				<form name="form1" method="post" action="linkmanlist.do">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td width="15%" nowrap>
								<input name="mobile" type="text"
									id="mobile" value="" style="width: 110px">
							</td>
							<td width="12%" nowrap>QQ号：</td>
							<td width="15%" nowrap>
								<input name="imNum" type="text"
									id="imNum" value="" style="width: 110px">
							</td>
						...
						<tr>
									...
									<tr>
										...
										<td width="21">
											<img src="${pageContext.request.contextPath}/ui/images/lookup.gif"
												...
												onClick="OpenWin('${pageContext.request.contextPath}/crm/customer/include/customerSelect.jsp')">
										</td>
									</tr>
								</table>
							</td>
							<td>QQ昵称：</td>
							<td>
								<input name="imName" type="text" id="imName" value=""
									style="width: 110px">
							</td>
							<td>办公电话：</td>
							<td>
						...
						<tr>
							<td>家庭电话：</td>
							<td>
								<input name="homeTel" type="text" id="homeTel" value=""
									style="width: 110px">
							</td>
							<td>电子邮件：</td>
							<td>
							...
							<td>所属人：</td>
							<td>
								<select id='ownerUser' name='ownerUser'
									style='width: 110px'>
	...
	<div class="border">
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<td>
					<a href="${pageContext.request.contextPath}/crm/customer/linkman/info.jsp">
						ddd
					</a>
				</td>
				<td>男</td>
			...
			<tr>
				...
				<td>
					<a href="linkmanlist.do?method=loadRead&id=3&m_type=customer">
						张国立
					</a>
				</td>
				<td>男</td>
			...
			<tr>
				...
				<td>
					<a href="linkmanlist.do?method=loadRead&id=2&m_type=customer">
						王刚
					</a>
				</td>
				<td>男</td>
			...
			<tr>
				...
				<td>
					<a href="linkmanlist.do?method=loadRead&id=1&m_type=customer">
						张丹枫
					</a>
				</td>
				<td>男</td>
