...
<body>
	<form name="ActionForm" method="post"
		action="${pageContext.request.contextPath}/crm/customer/linktouch/edit.jsp"
		...
		<div class="control">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linktouch.do?method=list')">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linktouch.do?method=load&id=0')" disabled>
				<img src="${pageContext.request.contextPath}/ui/images/button/daoshouye.png"
					border='0' align='absmiddle'>
				&nbsp;上一个
			</button>
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linktouch.do?method=load&id=3')">
				<img src="${pageContext.request.contextPath}/ui/images/button/daoweiye.png"
					border='0' align='absmiddle'>
				&nbsp;下一个
			</button>
		</div>
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="34%">
									<input type='text' id='linkMan'
										name='linkMan' value='王刚' style='width: 85%'
										class='combox-input'>
									<img src='${pageContext.request.contextPath}/ui/images/combox_b.jpg'
										id='link_manIMG' width='18' height='20' border='0'
										align='absmiddle' />
								
								
								<script>
									var link_man = new Roly.Combox('link_man',
											'link_manIMG');
									link_man.addItem('张丹枫');
									link_man.addItem('王刚');
									link_man.addItem('张国立');
									link_man.addItem('ddd');
									link_man.init();
								</script>
								...
								<td width="16%">联系方式：</td>
								<td width="34%">
									<select id='linkFashion' name='linkFashion'
										style='width: 90%'>
										<option value=''>------</option>
									...
									<img border='0' align='absmiddle'
										src='${pageContext.request.contextPath}/ui/images/service.gif'
										style='cursor: hand'
										onClick="OpenWin('${pageContext.request.contextPath}/sys/dictionary/batchEditDetails.jsp','',500,300)"></td>
							</tr>
							<tr>
								<td class="red">联系时间：</td>
								<td>
									<input type='text' id='linkTime' name='linkTime'
										class="dateClassStyle" value='2010-03-29' style='width: 90%'>
								</td>
								<td>联系类别：</td>
								<td>
							...
							<tr>
								...
								<td colspan="3">
									<button type='button' class='button'
										onMouseOver="this.className='button_over';"
										onMouseOut="this.className='button';"
										onClick="OpenWin('${pageContext.request.contextPath}/include/chooseDictionary.jsp','',580,400);">
							...
							<tr>
								<td>下次联系时间：</td>
								<td>
									<input type='text' id='nextTouchDate'
										name='nextTouchDate' class="dateClassStyle" value='2010-03-31'
										style='width: 90%'>
								</td>
								<td>业务员：</td>
								<td>
									<input type='text' id='userName' name='userName'
										value='系统管理员' style='width: 84%' class='combox-input'>
									<img src='${pageContext.request.contextPath}/ui/images/combox_b.jpg'
										id='user_nameIMG' width='18' height='20' border='0'
										align='absmiddle' />
								
								
								<script>
									var user_name = new Roly.Combox(
											'user_name', 'user_nameIMG');
									user_name.addItem('系统管理员');
									user_name.init();
								</script>
							...
							<tr>
								<td>下次联系目标：</td>
								<td colspan="3">
									<textarea name="nextTouchAim" rows="4"
										id="nextTouchAim" style="width: 96%">
									</textarea>
								</td>
							</tr>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="34%">
									<input name="creater" type="text"
										class="disabled" id="creater" value="系统管理员" style="width: 90%"
										readonly>
								</td>
								<td width="16%">创建时间：</td>
								<td width="34%">
									<input name="createTime" class="disabled"
										readonly value="2010-03-29 22:01:10" type="text"
							...
							<tr>
								...
								<td>
									...
									<input name="updater2" type="text" readonly id="updater2"
										value="系统管理员" class="disabled" style="width: 90%">
								</td>
								<td>修改时间：</td>
								<td>
									<input type="hidden" name="updateTime"
										value="2010-03-29 22:01:25"> 
									<input name="updateTimeStr2" class="disabled" readonly
										value="2010-03-29 22:01:10" type="text" id="updateTimeStr2"
										style="width: 90%">
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input name="ownerName" type="text" id="ownerName"
										class="disabled" style="width: 90%" readonly value="系统管理员">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
