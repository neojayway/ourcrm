...
<body>
	...
	<form action="${pageContext.request.contextPath}/crm/customer/file/edit.jsp"
		method="post" enctype="multipart/form-data" name="ActionForm"
		...
		<div class="control">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('file.do?method=list')">
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>文档等级：</td>
								<td>
									<select id='fileGrade' name='fileGrade'
										style='width: 90%'>
									...
									<img border='0' align='absmiddle'
										...
										style='cursor: hand'
										onClick="OpenWin('/sys/dictionary/detail.do?method=popeController&oid=file_grade&pid=13','',500,300)">
								</td>
								<td>文档类型：</td>
								<td>
									...
									<img border='0' align='absmiddle'
										src='${pageContext.request.contextPath}/ui/images/service.gif'
										style='cursor: hand'
										onClick="OpenWin('/sys/dictionary/detail.do?method=popeController&oid=file_type&pid=14','',500,300)"></td>
							</tr>
							<tr>
								<td>上传人：</td>
								<td>
									<input name="handler" type="text" id="handler"
										style="width: 90%" value="系统管理员">
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
					...
					<div id="menu2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>创建人：</td>
								<td>
									<input name="creator" type="text" class="disabled"
										id="creator" style="width: 90%" value="系统管理员" readonly>
								</td>
								<td>创建时间：</td>
								<td>
									<input name="createTimeStr" type="text"
										class="disabled" style="width: 90%" id="createTimeStr"
										value="2010-03-29 22:46:40" readonly>
								</td>
							</tr>
							<tr>
								<td>修改人：</td>
								<td>
									<input name="updater" type="text" class="disabled"
										id="updater" style="width: 90%" value="系统管理员" readonly>
								</td>
								<td>修改时间：</td>
								<td>
									<input name="updateTimeStr" type="text"
										class="disabled" style="width: 90%" id="updateTimeStr"
										value="2010-03-29 22:46:40" readonly>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									<input name="owner_name" type="text" id="owner_name"
