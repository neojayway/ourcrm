...
<body>
	<form name="ActionForm" method="post" enctype="multipart/form-data"
		action="${pageContext.request.contextPath}/crm/customer/file/edit.jsp"
							...
							<tr>
								...
								<td>
									...
									<img border='0' align='absmiddle'
										src='${pageContext.request.contextPath}/ui/images/service.gif'
										style='cursor: hand'
										onClick="OpenWin('/sys/dictionary/detail.do?method=popeController&oid=file_type&pid=14','',500,300)">
								</td>
							</tr>
							<tr>
								<td>上传人：</td>
							...
							<tr>
								...
								<td width="34%">
									<input name="creator" type="text"
										class="disabled" id="creator" value="系统管理员" style="width: 90%"
										readonly>
								</td>
								<td width="16%">创建时间：</td>
								<td width="34%">
									<input name="createTimeStr"
										class="disabled" readonly value="2010-03-29 22:52:39"
										type="text" id="createTimeStr" style="width: 90%">
								</td>
							</tr>
							<tr>
								<td>修改人：</td>
								...
								<td>
									<input type="hidden" name="updateTimeStr"
										value="2010-03-29 22:52:48"> 
									<input name="updateTimeStr2" 
										class="disabled" readonly
										value="2010-03-29 22:52:39" type="text" 
										id="updateTimeStr2" style="width: 90%">
								</td>
							</tr>
							<tr>
								<td>所属人：</td>
