				...
				<form name="form2" method="post" action="linktouchlist.do">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							...
							<td width="12%" nowrap>
								<input name="linkMan" type="text"
									id="linkMan" value="" style="width: 110px">
							</td>
							<td width="15%" nowrap>联系方式：</td>
							<td width="12%" nowrap>
								<select id='linkFashion'
									name='linkFashion' style='width: 110px'>
						...
						<tr>
							<td>业务员部门：</td>
							<td>
								<select id='owner_dpt' name='owner_dpt'
									style='width: 110px' onChange='getUsers(this.value)'>
									<option value='' selected>------</option>
							...
							<td>
								<span id="users">
									<select id='user_name2'
										name='user_name2' style='width: 110px'>
										<option value='' selected>------</option>
						...
						<tr>
							...
							<td>
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td width="100%">
											<input name="c_company" type="text"
												id="c_company" value="" style="width: 100%">
										</td>
										<td width="21">
											<img src="${pageContext.request.contextPath}/ui/images/lookup.gif"
												width="21" height="19" style="cursor: hand"
												onClick="searchCustomer2()">
										</td>
									</tr>
								</table>
							</td>
							<td>联系时间：</td>
							<td>
								<select name='queryTime' id='queryTime'
									style='width: 110px' onChange='changeQueryTime()'>
									<option value='' selected>------</option>
							...
							<td colspan="3">
								<div id="CustomTime" style="float: left; display: none;">
									从 
									<input type='text' id='beginTime2' name='beginTime'
										value='2010-02-28' style='width: 130px'>
									<img src='${pageContext.request.contextPath}/ui/images/Calendar.gif'
										name='beginTimeStrIMG2' style='cursor: hand'
										id='beginTimeStrIMG2' align='absmiddle' alt='选择日期' />
								
								
									<script language='JavaScript'>
										Calendar.setup({
											inputField : "beginTime2",
											ifFormat : "%Y-%m-%d",
											button : "beginTimeStrIMG2"
										});
									</script>
								
								
									到 
									<input type='text' id='endTime2' name='endTime'
										value='2010-03-30' style='width: 130px'>
									<img src='${pageContext.request.contextPath}/ui/images/Calendar.gif'
										name='endTimeStrIMG2' style='cursor: hand' id='endTimeStrIMG2'
										align='absmiddle' alt='选择日期' />
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td width="4%" class="listViewThS1">
					<input type="checkbox"
						name="checkall" value="" class="checkbox"
			...
			<tr>
				...
				<td>
					<a href="${pageContext.request.contextPath}/crm/customer/linktouch/info.jsp">
						与客户签订销售合同，客户咨询产品
					</a>
				</td>
				<td>2010-03-29</td>
				<td>
					<a href="javascript:forward('${pageContext.request.contextPath}/crm/customer/base/main.jsp')">
						北京软通动力软件技术有限公司
					</a>
				</td>
				<td>王刚</td>
			...
			<tr>
				...
				<td>
					<a href="linktouchlist.do?method=loadRead&id=3&m_type=roll">
						与客户签订销售合同，客户咨询产品
					</a>
				</td>
				<td>2010-03-29</td>
				<td>
					<a href="javascript:forward('/crm/customer/std/main.jsp?back=list&isFrom=cvisit&id=8')">
						北京软通动力软件技术有限公司
					</a>
				</td>
				<td>张丹枫</td>
			...
			<tr>
				...
				<td>
					<a href="linktouchlist.do?method=loadRead&id=2&m_type=roll">
						与客户签订销售合同，客户咨询产品
					</a>
				</td>
				<td>2010-03-29</td>
			...
			<tr>
				...
				<td>
					<a href="linktouchlist.do?method=loadRead&id=1&m_type=roll">
						与客户签订销售合同，跟客户沟通合同信息
					</a>
				</td>
				<td>2010-03-29</td>
