...
<frameset rows="80,*" cols="*">
  <frame src="${pageContext.request.contextPath}/newPagePlan/menu/top.jsp" name="topFrame"  id="topFrame"  scrolling="NO" 
                noresize="noresize" frameborder="0" >
  <frameset cols="220,*" id="frmstOuter">
    <frame src="${pageContext.request.contextPath}/newPagePlan/menu/left.jsp"  name="leftFrame"  id="leftFrame" 
