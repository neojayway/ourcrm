	...
	<div id="sidetreecontrol"><a href="?#">Collapse All</a> | <a href="?#">Expand All</a></div>
		<ul id="tree">
					...
					<ul>
						           ...
						           <a href="${pageContext.request.contextPath}/newPagePlan/crm/customer/base/list.jsp" target="rightFrame">客户拜访</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/lxrlb.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/crm/customer/linkman/view.jsp" target="rightFrame">联系人列表</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/lxjllb.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/crm/customer/linktouch/view.jsp" target="rightFrame">联系记录列表</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/khccsz.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/crm/customer/rule/rule.jsp" target="rightFrame">客户查重设置 </a></li>
					</ul>
				 </li>
					...
					<ul>     
						           ...
						           <a href="${pageContext.request.contextPath}/newPagePlan/sys/group/list.jsp" target="rightFrame">部门设置</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/rsgl.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/sys/user/list.jsp" target="rightFrame">人事管理</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/czqxz.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/sys/role/list.jsp" target="rightFrame">操作权限组</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/sfzl.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/sys/province/list.jsp" target="rightFrame">省份资料</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/cszl.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/sys/city/list.jsp" target="rightFrame">城市资料</a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/bmzj.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/sys/code/list.jsp" target="rightFrame">编码规则</a></li>
					</ul>
				 </li>
					...
					<ul>
						           ...
						           <a href="${pageContext.request.contextPath}/newPagePlan/report/khflfxReport.jsp" target="rightFrame">客户分类分析 </a></li>
						           <li><img src="${pageContext.request.contextPath}/ui/images/menu/khgjfx.png" width="17" height="17">
						           <a href="${pageContext.request.contextPath}/newPagePlan/report/khflfxReport.jsp" target="rightFrame">客户分析 </a></li>
					</ul>
				 </li>
		</ul>
