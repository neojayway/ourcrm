					...
					<form name="form2" method="post" action="linktouch.do">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="12%" nowrap>
									<select id='linkType'
										name='linkType' style='width: 110px'>
										<option value='' selected>------</option>
							...
							<tr>
								...
								<td>
									<input type='text' id='userName' name='userName'
										value='' style='width: 90px' class='combox-input'>
								...
								<td>下次联系目标：</td>
								<td>
									<input name="nextTouchAim" type="text"
										id="nextTouchAim" value="" style="width: 105px">
								</td>
								<td>联系记录：</td>
								<td>
								...
								<td colspan="3">
									<div id="CustomTime" style="float: left; display: none;">
										...
										<input type='text' id='beginTime2' name='beginTime'
											value='2010-02-28' style='width: 90px'>
										...
										<input type='text' id='endTime2' name='endTime'
											value='2010-03-29' style='width: 90px'>
										<img src='${pageContext.request.contextPath}/ui/images/Calendar.gif'
											name='endTimeStrIMG2' style='cursor: hand'
											id='endTimeStrIMG2' align='absmiddle' alt='选择日期' />
		...
		<form name="ActionForm" method="post" action="">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td>
						<a href="linktouch.do?method=load&id=2">
							与客户签订销售合同，客户咨询产品
						</a>
					</td>
					<td>2010-03-29</td>
				...
				<tr>
					...
					<td>
						<a href="linktouch.do?method=load&id=1">
							与客户签订销售合同，跟客户沟通合同信息
						</a>
					</td>
					<td>2010-03-29</td>
