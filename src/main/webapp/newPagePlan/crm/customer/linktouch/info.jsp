	...
	<form name="ActionForm" method="post" action="linktouch.do" onSubmit="">
		...
		<div class="control">
			<button type='button' class='button'
				...
				onClick="forward('linktouchlist.do?method=listAll&m_type=customer')">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linktouchlist.do?method=loadRead&id=0')" disabled>
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="forward('linktouchlist.do?method=loadRead&id=3')">
					...
					<div id="menu4">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="34%" class="tabDetailViewDF">2010-03-29
									22:01:10&nbsp;
								</td>
							</tr>
							<tr>
