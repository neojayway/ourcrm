					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="34%">
									<input type='text' id='linkMan' name='linkMan' 
										value='' style='width: 84%' class='combox-input'>
							...
							<tr>
								...
								<td>
									<input type='text' id='linkTime' class="dateClassStyle"
										name='linkTime' value='2010-03-29' style='width: 90%'>
								</td>
								<td>联系类别：</td>
								<td>
					...
					<div id="menu2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="16%">创建人：</td>
								<td width="34%">
									<input name="creater" class="disabled"
										type="text" id="creater" style="width: 90%" readonly
										value="系统管理员">
								</td>
								<td width="16%">创建时间：</td>
								<td width="34%">
									<input name="createTime" class="disabled"
										value="2010-03-29 21:14:38" type="text" id="createTime"
							...
							<tr>
								<td>修改人：</td>
								<td>
									<input name="updater" type="text" id="updater"
										class="disabled" style="width: 90%" readonly value="系统管理员">
								</td>
								<td>修改时间：</td>
								<td>
									<input name="updateTime" class="disabled"
										value="2010-03-29 21:14:38" type="text" id="updateTime"
										style="width: 90%" readonly>
								</td>
							</tr>
							<tr>
