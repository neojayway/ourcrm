...
<body>
	<form name="ActionForm" method="post"
		action="${pageContext.request.contextPath}/crm/customer/rule/rule.jsp"
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="red">
									<input type="hidden" name="id_4"
										value="customer_CheckRepeat"> 客户资料查重
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								...
								<td colspan="3">
									...
									<div class="checkbox">
										<input name="repeat_property" type="checkbox" class="checkbox"
											value="name" checked> 客户名称
									</div>
