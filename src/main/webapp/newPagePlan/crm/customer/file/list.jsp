...
<body>
							...
							<tr>
								<td colspan="3">创建时间：
									<input type='text' id='begintime'
										name='begintime' class="dateClassStyle" value=''
										style='width: 120px'> 
									&nbsp;至&nbsp; 
									<input type='text'
										id='endtime' name='endtime' class="dateClassStyle" value=''
										style='width: 120px'>
								</td>
							</tr>
						</table>
	...
	<div class="control">
		...
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';"
			onClick="delForm('${pageContext.request.contextPath}/crm/customer/file/view.jsp')">
		...
		<form name="ActionForm" method="post" action="">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td width="18%">
						<a href="file.do?method=load&id=3">
								0909171429301d533b84959f35.jpg
						</a>
					</td>
					<td width="13%">电子文档</td>
					<td width="12%">普通文件</td>
					<td width="14%">系统管理员</td>
					<td width="18%">2010-03-29</td>
					<td width="18%">
				...
				<tr>
					...
					<td width="18%">
						<a href="file.do?method=load&id=2">
							0909171429301d533b84959f35.jpg
						</a>
					</td>
					<td width="13%">电子文档</td>
				...
				<tr>
					...
					<td width="18%">
						<a href="file.do?method=load&id=1">
							jquery-datepick.rar
						</a>
					</td>
					<td width="13%">电子文档</td>
