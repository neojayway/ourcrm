...
<script type="text/javascript">
	...
	function goSet() {
		var id = $("#id").val();
		var url = "${pageContext.request.contextPath}/crm/companyAction_showShareSetOne.do?id="
			+ id;
...
<body>
	<form name="ActionForm" method="post"
		action="${pageContext.request.contextPath}/crm/companyAction_updateshareCancelOne.do">
			...
			<fieldset style='padding: 5px; clear: left;'>
				...
				<div>
					<input type='checkbox' class='checkbox' name='s_module'
						value='c_company' id='c_company'>客户资料
				</div>
				&nbsp;
			</fieldset>
		</div>
