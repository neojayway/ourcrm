...
<body>
	<form name="companyForm" method="post" action="companyAction_update.do" 
		namespace="/crm">
		<div class="mtitle">
		...
		<div class="control">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="OpenWin('/common/share/ShareSet.jsp?pid=7&owner_usr=1&c_name=777&m_type=customer','',500,400)">
			...
			<button type='button' class='button'
				onMouseOver="this.className='button_over';"
				onMouseOut="this.className='button';"
				onClick="do_backList('/crm/cvisit/customer.do?method=list');">
					...
					<div id="menu1">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									<input type="text" id="pycode" name="pycode"
										cssStyle="width:90%" readonly="true" cssClass="disabled" />
								</td>
								<td>客户等级：</td>
								<td>
									<c:if test="#request.gradesSelect!=null">
										<select list="#request.gradesSelect" name="grade" id="grade"
							...
							<tr>
								...
								<td>
									<c:if test="#request.regionNamesSelect!=null">
										<select list="#request.regionNamesSelect" name="regionName"
							...
							<tr>
								...
								<td>
									<c:if test="#request.provincesSelect!=null">
										<select list="#request.provincesSelect" name="province"
								...
								<td>城市：</td>
								<td>
									<c:if test="#request.citiesSelect!=null">
										<select list="#request.citiesSelect" name="city" id="city"
											listKey="name" listValue="name" headerKey=""
											headerValue="--------" cssStyle="width:90%">
										</select>
									</c:if>
								</td>
							...
							<tr>
								...
								<td>公司网站：</td>
								<td>
									<input type="text" name="web" id="web" cssStyle="width:90%" />
								</td>
							</tr>
							<tr>
								<td>电话一：</td>
								<td>
									<input type="text" name="tel1" id="tel1" cssStyle="width:90%" />
								</td>
								<td>传真：</td>
								<td>
									<input type="text" name="fax" id="fax" cssStyle="width:90%" />
								</td>
							</tr>
							<tr>
								<td>手机：</td>
								...
								<td>电话二：</td>
								<td>
									<input type="text" name="tel2" id="tel2" cssStyle="width:90%" />
								</td>
							</tr>
							<tr>
								<td>下次联系时间:</td>
					...
					<div id="menu2">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td>开户银行：</td>
								<td>
									<input type="text" name="bank" id="bank" cssStyle="width:90%" />
								</td>
								<td>银行账户：</td>
								<td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>
									...
									<!-- 变更的日期 --> 
									<input type="hidden" name="dispenseDate" />
								</td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
