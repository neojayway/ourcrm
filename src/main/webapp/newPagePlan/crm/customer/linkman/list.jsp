					...
					<form name="form2" method="post" action="linkman.do">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td>职务：</td>
								<td>
									<input name="duty" type="text" id="duty" value=""
										style="width: 110px">
								</td>
								<td>性别：</td>
								<td>
									<select name='sex' id='sex' style='width: 110px'>
							...
							<tr>
								...
								<td>QQ号：</td>
								<td>
									<input name="imNum" type="text" id="imNum" value=""
										style="width: 110px">
								</td>
								<td>QQ昵称：</td>
								<td>
							...
							<tr>
								<td>其他联系：</td>
								<td>
									<input name="otherLink" type="text" id="otherLink"
										value="" style="width: 110px">
								</td>
								<td>爱好：</td>
								<td>
									<input name="hobby" type="text" id="hobby" value=""
										style="width: 110px">
								</td>
								<td>忌讳：</td>
								<td>
									<input name="taboo" type="text" id="taboo" value=""
										style="width: 110px">
								</td>
							</tr>
							<tr>
								...
								<td colspan="3">
									<input name="address" type="text"
										id="address" value="" style="width: 100%">
								</td>
							</tr>
							<tr>
								<td>邮政编码：</td>
								...
								<td colspan="3">
									<input name="remark" type="text"
										id="remark" value="" style="width: 100%">
								</td>
							</tr>
							<tr>
								<td>出生日期：</td>
								<td>
									<input name="birthday" type="text" id="birthday"
										class="dateClassStyle" value="" style="width: 110px">
								</td>
							</tr>
						</table>
					</form>
		...
		<form name="ActionForm" method="post" action="">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td width="14%">
						<a href="linkman.do?method=load&id=2"> 王刚</a>
					</td>
					<td width="11%">男</td>
					<td width="20%">&nbsp;</td>
					<td width="11%">&nbsp;</td>
				...
				<tr>
					...
					<td width="14%">
						<a href="linkman.do?method=load&id=1"> 张丹枫</a>
					</td>
					<td width="11%">男</td>
					<td width="20%">&nbsp;</td>
					<td width="11%">&nbsp;</td>
