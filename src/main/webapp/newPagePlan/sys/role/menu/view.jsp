...
<body>
	<form name="ActionForm" method="post"
		action="${pageContext.request.contextPath}/sysMenuAction.do">
				...
				<tr>
					<td>
						<fieldset style='padding: 5px; clear: left;'>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='company,base' checked='checked' id='company_base'
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='company,linkMan' checked='checked' id='company_linkMan'
									onClick='goSelect(this.id)'>
								联系人列表
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='company,rule' checked='checked' id='company_rule'
									onClick='goSelect(this.id)'>
								客户查重设置
							</div>
						...
						<fieldset style='padding: 5px; clear: left;'>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='sys,group' checked='checked' id='sys_group'
									onClick='goSelect(this.id)'>
								部门设置
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='sys,user' checked='checked' id='sys_user'
									onClick='goSelect(this.id)'>
								人事管理
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='sys,role' checked='checked' id='sys_role'
									onClick='goSelect(this.id)'>
								操作权限组
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='sys,province' checked='checked' id='sys_province'
									onClick='goSelect(this.id)'>
								省份资料
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='sys,city' checked='checked' id='sys_city'
									onClick='goSelect(this.id)'>
								城市资料
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='sys,code' checked='checked' id='sys_code'
									onClick='goSelect(this.id)'>
								编码规则
							</div>
						...
						<fieldset style='padding: 5px; clear: left;'>
							<legend>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='report,report' id='report_report'
									onClick='goSelect(this.id)' checked='checked'>
								报表与分析
							</legend>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='report,khflfx' checked='checked' id='report_khflfx'
									onClick='goSelect(this.id)'>
								客户分类分析
							</div>
							...
							<div>
								<input type='checkbox' class='checkbox' name='menuModule'
									value='report,khfx' checked='checked' id='report_khfx'
									onClick='goSelect(this.id)'>
								客户分析
							</div>
