...
<body>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td width="38%" nowrap>模块名称： 
								<input name="module"
									type="text" id="module" value="" style="width: 140px">
							</td>
							...
							<td width="23%" align="center">
								<div class="control">
									...
									<button type='button' class='button'
										onMouseOver="this.className='button_over';"
										onMouseOut="this.className='button';"
										onClick="forward('rule.do?method=search')">
	...
	<div class="control">
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';" onClick="forward('add.jsp')">
		...
		<button type='button' class='button'
			onMouseOver="this.className='button_over';"
			onMouseOut="this.className='button';"
			onClick="delForm('rule.do?method=delete')">
		...
		<form name="ActionForm" method="post" action="">
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<tr>
					...
					<td>
						<a href="rule.do?method=load&id=9"> 联系人</a>
					</td>
					<td>MAN</td>
					<td>yyyyMMdd</td>
					<td>3</td>
				...
				<tr>
					...
					<td>
						<a href="rule.do?method=load&id=8"> 商品资料</a>
					</td>
					<td>P</td>
					<td>&nbsp;</td>
					<td>5</td>
				...
				<tr>
					...
					<td>
						<a href="rule.do?method=load&id=5"> 收款单</a>
					</td>
					<td>GATHER</td>
					<td>yyyyMMdd</td>
					<td>3</td>
				...
				<tr>
					...
					<td>
						<a href="rule.do?method=load&id=4"> 销售单</a>
					</td>
					<td>SALE</td>
					<td>yyyyMMdd</td>
					<td>3</td>
				...
				<tr>
					...
					<td>
						<a href="rule.do?method=load&id=3"> 客户资料</a>
					</td>
					<td>C</td>
					<td>yyyyMMdd</td>
					<td>3</td>
