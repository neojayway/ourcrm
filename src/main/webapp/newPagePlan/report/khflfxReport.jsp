...
<link href="${pageContext.request.contextPath}/ui/css/report.css"
	rel="stylesheet" type="text/css">
<script src="${pageContext.request.contextPath}/ui/js/win.js"
	type="text/javascript"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/ui/js/tabpane/js/tabpane.js"></script>
<link
	href="${pageContext.request.contextPath}/ui/js/tabpane/css/tab.css"
	rel="stylesheet" type="text/css">
