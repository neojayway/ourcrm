...
public interface WeatherWebServiceSoap {
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetWeatherbyCityName")
    @WebMethod(action = "http://WebXml.com.cn/getWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetWeatherbyCityNameResponse")
    public org.zhiqiang.lzw.weather.ArrayOfString getWeatherbyCityName(
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetSupportDataSet")
    @WebMethod(action = "http://WebXml.com.cn/getSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetSupportDataSetResponse")
    public org.zhiqiang.lzw.weather.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet();
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetWeatherbyCityNamePro")
    @WebMethod(action = "http://WebXml.com.cn/getWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetWeatherbyCityNameProResponse")
    public org.zhiqiang.lzw.weather.ArrayOfString getWeatherbyCityNamePro(
        @WebParam(name = "theCityName", targetNamespace = "http://WebXml.com.cn/")
        java.lang.String theCityName,
    ...
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetSupportCity")
    @WebMethod(action = "http://WebXml.com.cn/getSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetSupportCityResponse")
    public org.zhiqiang.lzw.weather.ArrayOfString getSupportCity(
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetSupportProvince")
    @WebMethod(action = "http://WebXml.com.cn/getSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "org.zhiqiang.lzw.weather.GetSupportProvinceResponse")
    public org.zhiqiang.lzw.weather.ArrayOfString getSupportProvince();
}
