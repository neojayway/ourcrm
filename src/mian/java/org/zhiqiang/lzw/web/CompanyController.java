...
public class CompanyController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/getAllCompany/{data}", method = RequestMethod.GET)
	protected @ResponseBody TreeSet<Company> getAllCompany(Model model, @PathVariable("data") String data)
			throws Exception {
		// 获取到所有数据保存到list集合
		...
		//model.addAttribute("companyList", treeSet);
